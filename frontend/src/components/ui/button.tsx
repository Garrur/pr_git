    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-[#111] text-white hover:bg-[#333] shadow-sm": variant === "default",
            "border border-[var(--color-border)] bg-transparent hover:bg-gray-100 hover:text-gray-900": variant === "outline",
